...
\begin{enumerate}
    ...
    \item \label{ref:tcc} J.~W.~Romein, ``An Efficient GPU-Based Correlator X-Engine Implemented Using Tensor Cores,'' \emph{Astronomy \& Astrophysics}, vol.~656, A52, 2021.  DOI: \texttt{10.1051/0004-6361/202141896}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lp{8cm}}
        ...
        \texttt{CorrelatorOp} & GPU correlator (full visibility matrix; Appendix~\ref{app:correlator}) \\
