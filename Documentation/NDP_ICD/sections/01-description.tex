...
The correlator mode cross-correlates all 512 inputs to produce a full visibility matrix using the Tensor Core Correlator (Appendix~\ref{app:correlator}). The integration time is configurable via the \cmd{COR} command.
